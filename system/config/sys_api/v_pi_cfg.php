...
define( 'DB_USER', getenv_docker('VnPI_DB_USER', 'root') );

/** MySQL database password */
define( 'DB_PASSWORD', getenv_docker('VnPI_DB_PASSWORD', 'password') );
 ...
 * @since 2.6.0
 */
define( 'AUTH_KEY',         getenv_docker('VnPI_AUTH_KEY',         'bfb714c14afef52bc306afb3cb570eda3d8708c7') );
define( 'SECURE_AUTH_KEY',  getenv_docker('VnPI_SECURE_AUTH_KEY',  '3ee018717d292404f3ad56d84509d7eaec0d042e') );
define( 'LOGGED_IN_KEY',    getenv_docker('VnPI_LOGGED_IN_KEY',    'f11d1f31042e35521bdd125b147a9632b8f5fda5') );
define( 'NONCE_KEY',        getenv_docker('VnPI_NONCE_KEY',        'a173dd2787b2fbdc0f4be81b9c4afb6ca5ba8507') );
define( 'AUTH_SALT',        getenv_docker('VnPI_AUTH_SALT',        'e8577220d8900ddbc26305d39056edbbf4ff5391') );
define( 'SECURE_AUTH_SALT', getenv_docker('VnPI_SECURE_AUTH_SALT', '4f981db7e93f4ba97892d7458e44fe43c7cacabc') );
define( 'LOGGED_IN_SALT',   getenv_docker('VnPI_LOGGED_IN_SALT',   '272ade07a3dd782a15b4b4f5360e827049c18f46') );
define( 'NONCE_SALT',       getenv_docker('VnPI_NONCE_SALT',       '55063a40badf9fb6237a5db69ed35f0953f3cafb') );
 ...
 */
$table_prefix = getenv_docker('VnPI_TABLE_PREFIX', 'wp_');
 ...
 * @link ####
 */
define( 'V_PI_DEBUG', !!getenv_docker('VnPI_DEBUG', '') );
...
/*
if ($configExtra = getenv_docker('VnPI_CONFIG_EXTRA', '')) {
	eval($configExtra);
}
*/
