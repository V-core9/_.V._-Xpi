...
# Author: [_.V._] 
# Date: 20210611.05:44
# From Node File >>  "_create_folders": " bash -c \" cd system ; mkdir certs ; mkdir certs-data ; mkdir logs ; cd .. ; mkdir  mysql ; cp -r SOURCE PUBLIC ; cp 'system/build/Installer_API.sh' 'PUBLIC/' \" ; ",
echo " "
echo "*********************************************"
...
ls -l
cp -r SOURCE PUBLIC 
cp './system/build/Installer_API.sh' './PUBLIC/'
