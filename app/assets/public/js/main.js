...
$(document).ready(function(){
	...
	$(document).on('click', '#homepage, #home_logo, .open_homepage', function(){
	    open_static_page('templates/public/static_pages/home_page/index.php', 'Homepage', '');
	});
	 
	// show dashboard page
	$(document).on('click', '#aboutuspage', function(){
	    open_static_page('templates/public/static_pages/about_us_page/index.php', 'About us page', 'about-us');
	});
