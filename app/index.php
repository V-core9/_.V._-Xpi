...
<!-- navbar -->
<nav class="navbar navbar-expand-md navbar-dark bg-dark fixed-top topAppNavbar">
...
<script src="assets/js/public-helpers.js"></script>
<script src="assets/js/public-navigation.js"></script>
